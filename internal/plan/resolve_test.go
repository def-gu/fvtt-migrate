...
func TestPremiumIsNeverShared(t *testing.T) {
	...
	p := find(t, ResolvePackages(inv, Options{TargetCore: "13.351", Cache: fakeCache{"module/pf2e-kingmaker@1.2.0": true}}), "pf2e-kingmaker")
...
func TestDefaultPolicyIsPin(t *testing.T) {
	...
	if got := ResolvePackages(inv, Options{TargetCore: "13.351"})[0].Policy; got != PolicyPin {
